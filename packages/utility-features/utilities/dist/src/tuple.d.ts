 ...
 */
declare function zip<T>(...sources: Tuple<T[], 0>): Iterator<Tuple<T, 0>, Tuple<T[], 0>>;
declare function zip<T>(...sources: Tuple<T[], 1>): Iterator<Tuple<T, 1>, Tuple<T[], 1>>;
declare function zip<T>(...sources: Tuple<T[], 2>): Iterator<Tuple<T, 2>, Tuple<T[], 2>>;
/**
 ...
 */
declare function filled<T, L extends number>(length: L, value: T): Tuple<T, L>;
/**
 * A function for converting an explicit array to a tuple but without the `readonly` typing
 */
declare function from<T extends any[]>(...args: T): [...T];
