 ...
 */
declare function filled<T>(length: number, value: T): T[];
/**
 ...
 */
declare function split<T>(src: T[], element: T): [T[], T[], boolean];
declare function bifurcate<T>(src: T[], condition: (item: T) => any): [falses: T[], trues: T[]];
