...
export class KubeAuthProxy {
  ...
  public async run(): Promise<void> {
    ...
    const configWatcher = watch(this.cluster.kubeconfigPath(), (eventType: string, _filename: string) => {
      if (eventType === "change") {
  ...
  protected async sendIpcLogMessage(data: string, stream: string): Promise<void> {
