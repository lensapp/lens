...
import { defaultHotbarCells, getEmptyHotbar, HotbarItem } from "../../../common/hotbar-store/hotbar-types";
...
function getMirgation({ userDataPath }: Dependencies): MigrationDeclaration<HotbarStoreModel> {
  return {
