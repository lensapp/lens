...
async function kubeApiRequest({ req, socket, head, cluster }: ProxyApiRequestArgs) {
...
const kubeApiRequestInjectable = getInjectable({
  instantiate: () => kubeApiRequest,
  lifecycle: lifecycleEnum.singleton,
});

export default kubeApiRequestInjectable;
