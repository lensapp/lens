...
export class ShellSession extends EventEmitter {
  ...
  protected async getCachedShellEnv(): Promise<Record<string, string>> {
  ...
  protected async getShellEnv(): Promise<Record<string, string>> {
  ...
  protected pipeStdout(): void {
    ...
    this.shellProcess.on("data", ((data: string): void => {
  ...
  protected pipeStdin(): void {
    ...
    this.websocket.on("message", function (data: string): void {
      if (!this.running) {
        return; 
      }
