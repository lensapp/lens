...
export class Router {
  ...
  protected async getRequest(opts: { req: http.IncomingMessage; res: http.ServerResponse; cluster: Cluster; url: URL; params: RouteParams }): Promise<LensApiRequest> {
  ...
  protected handleStaticFile(file: string, response: http.ServerResponse): void {
