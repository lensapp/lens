...
export class ResourceApplier {
  ...
  protected sanitizeObject(resource: KubeObject): void {
...
export async function apply(cluster: Cluster, pathToKubeconfig: string, resource: any): Promise<string> {
  return (new ResourceApplier(cluster, pathToKubeconfig)).apply(resource);
}
