...
import { CoreV1Api, V1Secret, Config } from "@kubernetes/client-node";

function generateKubeConfig(username: string, secret: V1Secret, cluster: Cluster): Config {
...
class KubeconfigRoute extends LensApi {
  ...
  public async routeServiceAccountRoute(request: LensApiRequest): Promise<void> {
