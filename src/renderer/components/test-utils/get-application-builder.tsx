...
import type { MinimalTrayMenuItem } from "../../../behaviours/tray/main/electron-tray/electron-tray.injectable";
import electronTrayInjectable from "../../../behaviours/tray/main/electron-tray/electron-tray.injectable";
