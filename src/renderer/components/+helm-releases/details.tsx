...
import createUpgradeChartTabInjectable from "../dock/upgrade-chart/create-tab.injectable";
import updateReleaseInjectable from "./update-release.injectable";
import releaseInjectable from "./details/release.injectable";
import releaseDetailsInjectable from "./details/release-details.injectable";
import releaseValuesInjectable from "./details/release-values.injectable";
import userSuppliedValuesAreShownInjectable from "./details/user-supplied-values-are-shown.injectable";
