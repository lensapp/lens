...
import LensLogo from "../../svgs/lens-logo.svg";
  ...
  render() {
    ...
    return (
      <DropFileInput onDropFiles={this.onDropKubeConfig}>
        <PageLayout className="AddClusters" header={<><SvgIcon component={LensLogo} fontSize="large"/> <h2>Add Clusters</h2></>} showOnTop={true}>
