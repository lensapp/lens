...
export class ClusterStore {
  ...
  public removeClustersByWorkspace(workspace: string): void {
  ...
  public storeCluster(cluster: ClusterBaseInfo): void {
  ...
  public storeClusters(clusters: ClusterBaseInfo[]): void {
